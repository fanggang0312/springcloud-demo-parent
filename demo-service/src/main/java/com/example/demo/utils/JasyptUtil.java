...
public class JasyptUtil {
     ...
     * 8、setStringOutputType：设置字符串输出的编码形式。可用的编码类型有 base64、hexadecimal
     *
     * @param secretKey
     * @return
     */
    ...
    public static void main(String[] args) throws Exception {
        ...
        String jasyptEncrypt1 = stringEncryptor(secretKey, "o5zisoiq0sY3SrT5ZNgnpPc6XmNq29X+", false);
